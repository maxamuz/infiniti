...
<div class="container container-footer">
    <footer id="colophon" class="site-footer">
        ...
        <div class="company-info">
            ...
            <p class="company-info-item">ООО «Инфинити Маркет»</p>
            <p class="company-info-item">Реквизиты:<span> ИНН 9724045718, <br> ОГРН 1217700195173</span></p>
...
<div class="container container-footer-mobile">
    <footer id="colophon-mobile" class="site-footer">
        ...
        <div class="company-info">
            <p class="company-info-item">© Infiniti Market <?php echo date('Y'); ?></p>
            <p class="company-info-item">ООО «Инфинити Маркет»</p>
            <p class="company-info-item">Реквизиты:<br> ИНН 9724045718,<br> ОГРН 1217700195173</p>
            <a href="#" class="company-info-item">Политика конфиденциальности</a>
        </div>
...
<div class="cookie-consent" id="cookieConsent">
    <div class="cookie-consent-content">
        <p>ООО «Инфинити Маркет» использует cookies-файлы и рекомендательные технологии с целью персонализации сервисов и повышения удобства пользования веб-сайтом. Если вы не хотите использовать файлы cookie, измените настройки браузера.
