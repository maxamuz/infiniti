    ...
    <section class="cta-form" id="contacts">
        <div class="wrap">
            <div class="form-grid reveal">
                ...
                <div class="map-panel">
                    <div class="map-ya">
                        <div style="position:relative;overflow:hidden;"><a href="https://yandex.ru/maps/213/moscow/?utm_medium=mapframe&utm_source=maps" style="color:#eee;font-size:12px;position:absolute;top:0px;left: 100px;">Москва</a><a href="https://yandex.ru/maps/213/moscow/house/zagorodnoye_shosse_7as3/Z04YcAZkTkIHQFtvfXp4dHxhYw==/?ll=37.614770%2C55.695028&utm_medium=mapframe&utm_source=maps&z=17" style="color:#eee;font-size:12px;position:absolute;top:14px;">Загородное шоссе, 7Ас3 на карте Москвы, ближайшее метро Крымская — Яндекс Карты</a><iframe src="https://yandex.ru/map-widget/v1/?ll=37.614770%2C55.695028&mode=whatshere&whatshere%5Bpoint%5D=37.614770%2C55.695027&whatshere%5Bzoom%5D=17&z=17" width="560" height="400" frameborder="1" allowfullscreen="true" style="position:relative;border-radius: 20px;"></iframe></div>
                    </div>
