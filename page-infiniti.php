    ...
    <div class="container">
        ...
        <div class="scaner-container">
            <div class="scaner-content">
                <p>
                    В нашем автосервисе мы специализируемся на ремонте Infiniti и используем профессиональное оборудование для максимально точной диагностики.
                </p>
                <p>
                    Для проверки электронных систем автомобилей Nissan и Infiniti применяем Consult III Plus — это фирменный диагностический комплекс, который даёт доступ к данным на уровне официального дилера.
                </p>
                <p>
                    В отличие от стандартных сканеров, которые лишь фиксируют код ошибки, Consult III Plus позволяет нашим мастерам «заглянуть глубже» в работу автомобиля.
                </p>
                <p>
                    С его помощью мы отслеживаем актуальные параметры систем в режиме реального времени, анализируем взаимосвязи между разными блоками управления и выполняем сервисные процедуры, рекомендованные производителем.
                </p>
                <p>
                    Наша цель — не просто выявить ошибку, а докопаться до её первопричины и исключить риск повторной неисправности.
                </p>
            </div>
            <div class="scaner-rigth-content">
                ...
                <p>
                    По итогам диагностики вы получите чёткое и понятное заключение: мы не используем сухой технический язык, а объясняем всё простыми словами. Вместе с отчётом подготовим план дальнейших действий — разберём возможные варианты ремонта, озвучим стоимость работ и согласуем с вами оптимальный путь решения проблемы. До начала любых процедур подробно обсудим результаты диагностики и ответим на все вопросы.
                </p>
            </div>
        </div>
        ...
        <div class="contacts-grid">
            <div class="contacts-grid-item">
                ...
                <p class="contact-content">
                    <?php
                    if (function_exists('theme_settings_get_phone')) {
                        echo theme_settings_get_phone();
                    }
                    ?>
                </p>
            </div>
            <div class="contacts-grid-item">
                ...
                <p class="contact-content">
                    <?php
                    if (function_exists('theme_settings_get_whatsapp')) {
                        echo theme_settings_get_whatsapp();
                    }
                    ?>
                </p>
            </div>
            ...
            <div class="contacts-grid-item">
                ...
                <p class="contact-content">
                    <?php
                    if (function_exists('theme_settings_get_address')) {
                        echo theme_settings_get_address();
                    }
                    ?>
                </p>
            </div>
