...
/**
 * Template Name: Ремонт Nissan
 * Description: Шаблон для страницы ремонта Nissan
 */
    ...
    <div class="container container-hero">
        ...
        <div class="hero-info-block">
            <div class="info-block-models">
                <img src="<?php echo get_template_directory_uri() . '/img/lineicons_nissan.png' ?>" alt="Nissan">
        ...
        <div class="servises-cards">
            ...
            <div class="servises-card-item">
                ...
                <ul class="servises-card-list">
                    ...
                    <li>Замена тормозной жидкости: от 2000 руб.</li>
            ...
            <div class="servises-card-item">
                ...
                <ul class="servises-card-list">
                    ...
                    <li>Замена передней фары: от 5000 руб.</li>
                    <li>Замена блока предохранителей: от 4000 руб.</li>
                </ul>
                <div class="servises-card-button-block">
                    <a href="#" class="card-button-item">Еще</a>
                    <a href="#about-form" class="card-button-offer">Записаться</a>
